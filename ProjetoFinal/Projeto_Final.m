...
for i=1:Num_Elem%for rodando de 1 até o numero de elementos da matriz de incidencia (todas as linhas da primeira coluna)
    ...
    K(:,:,i)=((material(i,1)*propriedades(i)/comprimento))*[(cos^2) (cos*sen) (-(cos^2)) (-(cos*sen)); (cos*sen) (sen^2) (-(sen*cos)) (-(sen^2)); (-(cos^2)) (-(sen*cos)) (cos^2) (cos*sen);(-(sen*cos)) (-(sen^2)) (cos*sen) (sen^2)];%((material(i)*propriedades(i)/comprimento))= E*A/l*[]
