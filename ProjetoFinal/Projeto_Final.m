...
ug=U;%ug contem agora os nos com valor 0 que são restritos e os nós livres que estavam em u 
...
for i = 1:Num_Elem
    Deform(i)=(1/Incidencia2(i,3))*[-(Incidencia2(i,4)) -(Incidencia2(i,5)) Incidencia2(i,4) Incidencia2(i,5)]*U(GDL(i,:));
    Tensao(i)=(material(i,1)/Incidencia2(i,3))*[-(Incidencia2(i,4)) -(Incidencia2(i,5)) Incidencia2(i,4) Incidencia2(i,5)]*U(GDL(i,:));
end 